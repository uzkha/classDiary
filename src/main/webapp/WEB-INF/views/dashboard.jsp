        ...
        <div class="row">
            ...
            <div class="col-md-3">                
                <div class="list-group">
                    ...
                    <a href="javascript:;" onclick="ajaxGet('/classdiary/chamada/')" class="list-group-item">Chamada</a>
                </div>
                <div class="list-group">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"
					aria-hidden="true">&times;</button>
				<h4 id="h-componente-falha-requisicao-titulo" class="modal-title">Falha
					na Requisição</h4>
			</div>
			<div class="modal-body">
				<p id="p-componente-falha-requisicao-mensagem">MENSAGEM</p>
